  ...
  return (
    <aside className="hidden border-r bg-sidebar text-sidebar-foreground md:block w-64">
      <div className="flex h-full max-h-screen flex-col gap-2">
        <div className="flex h-40 items-center justify-center border-b border-sidebar-border px-6">
          <Link href="/dashboard" className="flex flex-col items-center gap-2 text-lg font-semibold text-sidebar-primary">
            <Image src={appLogo} alt="Ledna Platform Logo" width={252} height={252} className="h-32 w-32" data-ai-hint="company logo" />
