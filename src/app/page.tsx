      ...
      <main className="flex-grow">
        ...
        <section className="relative py-20 md:py-32 bg-gradient-to-br from-secondary/30 to-background">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            {/* THIS IS THE MODIFIED LINE FOR TROUBLESHOOTING */}
            <Image src="https://placehold.co/80x80.png" alt="Ledna Commodities Logo Placeholder" width={80} height={80} className="mx-auto mb-6" data-ai-hint="company logo large" />
